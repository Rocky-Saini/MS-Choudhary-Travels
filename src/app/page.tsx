        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <div className="border-t border-gray-800 mt-10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 bg-gray-800 px-4 py-2.5 rounded-xl flex-wrap justify-center">
              ...
              <a href="https://pay.google.com/gp/p/ui/pay?pa=codesefod@ybl&pn=Rocky+Saini&am=20&cu=INR&tn=Support+Developer" target="_blank" rel="noopener noreferrer" className="px-3 py-1 bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-bold rounded-lg transition-colors">₹20</a>
              <a href="https://pay.google.com/gp/p/ui/pay?pa=codesefod@ybl&pn=Rocky+Saini&am=50&cu=INR&tn=Support+Developer" target="_blank" rel="noopener noreferrer" className="px-3 py-1 bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-bold rounded-lg transition-colors">₹50</a>
              <a href="https://pay.google.com/gp/p/ui/pay?pa=codesefod@ybl&pn=Rocky+Saini&am=100&cu=INR&tn=Support+Developer" target="_blank" rel="noopener noreferrer" className="px-3 py-1 bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-bold rounded-lg transition-colors">₹100</a>
              <a href="https://pay.google.com/gp/p/ui/pay?pa=codesefod@ybl&pn=Rocky+Saini&cu=INR&tn=Support+Developer" target="_blank" rel="noopener noreferrer" className="px-3 py-1 bg-indigo-500 hover:bg-indigo-600 text-white text-xs font-bold rounded-lg transition-colors">Custom</a>
            </div>
